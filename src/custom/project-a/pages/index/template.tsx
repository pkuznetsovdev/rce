    ...
    <>
      ...
      <Layout className={mainClass} title='What?'>
        <CE.Block modifiers={['section', 'container']}>
          ...
          <CE.Text>It is designed to provide another level of development experience.</CE.Text>
          <CE.Text>It handles your HTML and CSS development routine as jQuery does with JavaScript.</CE.Text>
