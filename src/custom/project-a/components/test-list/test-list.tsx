...
const imgSrcByConfig = 'https://www.frommers.com/system/media_items/attachments/000/866/196/s980/p264_cp.jpg';
...
export const TestList = () => {
  return (
    <CE.List className='test' modifiers={['grid']}>
      ...
      <>
        <CE.Text modifiers={['subtitle']} tag='span' text='content by prop' config='content by default value' />
        <CE.Text>
          Element affected be <i>nextByName</i> mixin
        </CE.Text>
        <CE.Image modifiers={['by-default']} config={imgSrcByDefault} src={imgSrcByProps} />
      </>
      <>
